...
Deposit::Deposit(
	...
	m_dInterestRate(t_dInterestRate),
...
double Deposit::get_dDeposit()const { return s_dDeposit; }
double Deposit::get_dInterestRate()const { return m_dInterestRate; }
...
void Deposit::set_dDeposit(double t_dDeposit) { s_dDeposit = t_dDeposit; }
void Deposit::set_dInterestRate(double t_dInterestRate) { m_dInterestRate = t_dInterestRate; }
